 ...
 * @since 0.7
 */
public class RDFXMLResourceImpl extends JenaResourceImpl implements RDFXMLResource {

	public RDFXMLResourceImpl() {
		super();
	...
	public void doLoad(InputStream inputStream, Map<?, ?> options) throws IOException {
		...
		try {
			...
			final com.hp.hpl.jena.rdf.model.RDFReader reader = aModel.getReader();
	...
	public void doSave(OutputStream outputStream, Map<?, ?> options) throws IOException {
		...
		if (!aModel.isEmpty()) {
			com.hp.hpl.jena.rdf.model.RDFWriter writer = aModel.getWriter("RDF/XML-ABBREV");
