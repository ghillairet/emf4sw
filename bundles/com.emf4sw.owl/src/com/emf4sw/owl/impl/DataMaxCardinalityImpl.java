...
public class DataMaxCardinalityImpl extends DataPropertyRestrictionImpl implements DataMaxCardinality {
	...
	public DataProperty getProperty() {
		if (property != null && property.eIsProxy()) {
			...
			if (property != oldProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OWLPackage.DATA_MAX_CARDINALITY__PROPERTY, oldProperty, property));
			}
		}
		return property;
	}
	...
	public void setProperty(DataProperty newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.DATA_MAX_CARDINALITY__PROPERTY, oldProperty, property));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OWLPackage.DATA_MAX_CARDINALITY__PROPERTY:
