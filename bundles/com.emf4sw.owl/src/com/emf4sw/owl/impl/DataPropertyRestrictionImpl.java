...
public abstract class DataPropertyRestrictionImpl extends ClassExpressionImpl implements DataPropertyRestriction {
	...
	public void setNodeID(String newNodeID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.DATA_PROPERTY_RESTRICTION__NODE_ID, oldNodeID, nodeID));
	}
	...
	public RDFGraph getGraph() {
		if (eContainerFeatureID() != OWLPackage.DATA_PROPERTY_RESTRICTION__GRAPH) return null;
	...
	public NotificationChain basicSetGraph(RDFGraph newGraph, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newGraph, OWLPackage.DATA_PROPERTY_RESTRICTION__GRAPH, msgs);
		return msgs;
	}
	...
	public void setGraph(RDFGraph newGraph) {
		if (newGraph != eInternalContainer() || (eContainerFeatureID() != OWLPackage.DATA_PROPERTY_RESTRICTION__GRAPH && newGraph != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.DATA_PROPERTY_RESTRICTION__GRAPH, newGraph, newGraph));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OWLPackage.DATA_PROPERTY_RESTRICTION__GRAPH:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OWLPackage.DATA_PROPERTY_RESTRICTION__NODE_ID:
				return getNodeID();
			case OWLPackage.DATA_PROPERTY_RESTRICTION__GRAPH:
				return getGraph();
		}
