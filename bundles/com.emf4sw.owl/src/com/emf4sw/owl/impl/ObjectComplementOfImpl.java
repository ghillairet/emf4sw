...
public class ObjectComplementOfImpl extends ClassExpressionImpl implements ObjectComplementOf {
	...
	/**
	 * The cached value of the '{@link #getComplementOf() <em>Complement Of</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getComplementOf()
	 * @generated
	 * @ordered
	 */
	protected EList<ClassExpression> complementOf;
	...
	public void setNodeID(String newNodeID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.OBJECT_COMPLEMENT_OF__NODE_ID, oldNodeID, nodeID));
	}
	...
	public RDFGraph getGraph() {
		if (eContainerFeatureID() != OWLPackage.OBJECT_COMPLEMENT_OF__GRAPH) return null;
	...
	public NotificationChain basicSetGraph(RDFGraph newGraph, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newGraph, OWLPackage.OBJECT_COMPLEMENT_OF__GRAPH, msgs);
		return msgs;
	}
	...
	public void setGraph(RDFGraph newGraph) {
		if (newGraph != eInternalContainer() || (eContainerFeatureID() != OWLPackage.OBJECT_COMPLEMENT_OF__GRAPH && newGraph != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.OBJECT_COMPLEMENT_OF__GRAPH, newGraph, newGraph));
	}
	...
	public EList<ClassExpression> getComplementOf() {
		if (complementOf == null) {
			complementOf = new EObjectResolvingEList<ClassExpression>(ClassExpression.class, this, OWLPackage.OBJECT_COMPLEMENT_OF__COMPLEMENT_OF);
		}
		return complementOf;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OWLPackage.OBJECT_COMPLEMENT_OF__GRAPH:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OWLPackage.OBJECT_COMPLEMENT_OF__NODE_ID:
				return getNodeID();
			case OWLPackage.OBJECT_COMPLEMENT_OF__GRAPH:
				return getGraph();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case OWLPackage.OBJECT_COMPLEMENT_OF__GRAPH:
				...
				return;
			case OWLPackage.OBJECT_COMPLEMENT_OF__COMPLEMENT_OF:
				getComplementOf().clear();
				getComplementOf().addAll((Collection<? extends ClassExpression>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case OWLPackage.OBJECT_COMPLEMENT_OF__COMPLEMENT_OF:
				return complementOf != null && !complementOf.isEmpty();
		}
