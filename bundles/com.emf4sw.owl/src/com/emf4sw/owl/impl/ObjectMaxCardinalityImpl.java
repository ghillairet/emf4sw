 ...
 * <ul>
 *   <li>{@link com.emf4sw.owl.impl.ObjectMaxCardinalityImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link com.emf4sw.owl.impl.ObjectMaxCardinalityImpl#getOnClass <em>On Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ObjectMaxCardinalityImpl extends ObjectPropertyRestrictionImpl implements ObjectMaxCardinality {
	/**
	...
	public ClassExpression getOnClass() {
		if (onClass != null && onClass.eIsProxy()) {
			...
			if (onClass != oldOnClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OWLPackage.OBJECT_MAX_CARDINALITY__ON_CLASS, oldOnClass, onClass));
			}
		}
		return onClass;
	}
	...
	public void setOnClass(ClassExpression newOnClass) {
		...
		onClass = newOnClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OWLPackage.OBJECT_MAX_CARDINALITY__ON_CLASS, oldOnClass, onClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OWLPackage.OBJECT_MAX_CARDINALITY__ON_CLASS:
